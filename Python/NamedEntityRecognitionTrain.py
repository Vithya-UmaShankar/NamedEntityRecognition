...
def generate_rules(patterns):
    ...
    nlp.to_disk("NamedEntityRecognition")


# In[30]:


path = os.path.join("Tensorflow", "Projects", "NamedEntityRecognition", "CSV")
...
nlp = spacy.load("NamedEntityRecognition")
...
save_data("NamedEntityRecognitionTrainingData.json", TRAIN_DATA)
...
TRAIN_DATA = load_data("NamedEntityRecognitionTrainingData.json")
nlp = train_model(TRAIN_DATA, 20)
nlp.to_disk("NamedEntityRecognitionModel")
